  ...
  void Read_Control_File(const char *control_file, control_params *control)
  {
    ...
    try {
      ...
      while (true) {
        ...
        // } else if (keyword == "nnflag") {
        //  control->nnflag = values.next_int();   
        } else if (keyword == "belayer_m") {
          control->belayer_m = values.next_int(); 
        } else if (keyword == "belayer_n") {
          control->belayer_n = values.next_int(); 
        } else if (keyword == "mflayer_m") {
          control->mflayer_m = values.next_int(); 
        } else if (keyword == "mflayer_n") {
          control->mflayer_n = values.next_int();    
        } else {
