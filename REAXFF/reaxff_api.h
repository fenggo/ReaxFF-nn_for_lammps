...
extern void BO(reax_system *, control_params *, storage *, reax_list **);
...
extern void fnn(rvec, network_parameters *, rvec, rvec9, int, int);
extern double enn(rvec, network_parameters **, rvec, int, int);

// bonds

extern void Bonds(reax_system *, control_params *, simulation_data *, storage *, reax_list **);
...
inline void rvec_Add(rvec ret, rvec v1, rvec v2)
{
  ret[0] = v1[0]  +  v2[0];
  ret[1] = v1[1]  +  v2[1];
  ret[2] = v1[2]  +  v2[2];
...
inline void rvec_Minus(rvec ret, rvec v1, rvec v2)
{
  ret[0] = v1[0]  -  v2[0];
  ret[1] = v1[1]  -  v2[1];
  ret[2] = v1[2]  -  v2[2];
