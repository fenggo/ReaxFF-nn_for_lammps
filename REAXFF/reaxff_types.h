...
struct dbond_coefficients {
  double C1dbo, C2dbo, C3dbo,C4dbo;
  double C1dbos, C2dbos, C3dbos,C4dbos;
  double C1dbopi, C2dbopi, C3dbopi, C4dbopi;
  double C1dbopi2, C2dbopi2, C3dbopi2, C4dbopi2;
  // new parameters add for nn
  double C1dDelta, C2dDelta, C3dDelta,C4dDelta;
};
...
struct reax_interaction {
  ...
  network_parameters **ennp;
  network_parameters *fnnp;
};
...
struct bond_order_data {
  ...
  double Cdbo, Cdbopi, Cdbopi2 , Cdbos;
  double C1dbo, C2dbo, C3dbo,C4dbo;
  double C1dbos, C2dbos, C3dbos, C4dbos;
  double C1dbopi, C2dbopi, C3dbopi, C4dbopi;
  double C1dbopi2, C2dbopi2, C3dbopi2, C4dbopi2;
